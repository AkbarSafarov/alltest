...
class CheckboxColumn extends Column
{
    ...
    protected function renderHeaderCellContent()
    {
        ...
        $checkbox_input = Html::checkbox($this->getHeaderCheckBoxName(), false, [
            'class' => 'form-check-input',
            'id' => 'grid-view-' . $this->grid->options['id'] . '-all',
        ]);
        
        $checkbox_label = Html::label(null, 'grid-view-' . $this->grid->options['id'] . '-all', [
            'class' => 'form-check-label',
        ]);
        
        return Html::tag('div', $checkbox_input . $checkbox_label, ['class' => 'form-check form-check-primary']);
    }
    ...
    protected function renderDataCellContent($model, $key, $index)
    {
        ...
        $key = is_array($key) ? Json::encode($key) : $key;
        ...
        $options['id'] = 'grid-view-' . $this->grid->options['id'] . "-$key";
        
        $checkbox_input = Html::checkbox($this->name, !empty($options['checked']), $options);
        $checkbox_label = Html::label(null, 'grid-view-' . $this->grid->options['id'] . "-$key", [
            'class' => 'form-check-label',
        ]);
